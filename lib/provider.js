...
function satisfyDependencies() {
  ...
  __webpack_require__(5).install(_package_json__WEBPACK_IMPORTED_MODULE_3__.name);

  const ref = _package_json__WEBPACK_IMPORTED_MODULE_3__['package-deps'];
  const results = [];
...
function provideBuilder() {
  return class HomebrewProvider extends events__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"] {
    constructor(cwd) {
      super();
      this.cwd = cwd;
    }
    ...
    isEligible() {
      if (atom.config.get(_package_json__WEBPACK_IMPORTED_MODULE_3__.name + '.alwaysEligible') === true) {
        return true;
      }

      const cmd = Object(child_process__WEBPACK_IMPORTED_MODULE_1__["spawnSync"])(which(), ['brew']);
    ...
    settings() {
      const auditMatch = ['(?<file>.+): \\* C: (?<line>\\d+): col (?<col>\\d+): (?<message>.+)'];
      return [{
...
function activate() {
  if (atom.config.get(_package_json__WEBPACK_IMPORTED_MODULE_3__.name + '.manageDependencies') === true) {
    satisfyDependencies();
  }
}
...
module.exports = {"name":"build-homebrew","version":"0.2.1","description":"Atom Build provider for Homebrew formulas","repository":"https://github.com/idleberg/atom-build-homebrew","license":"MIT","scripts":{"build":"webpack --mode none","dev":"webpack --mode none --watch","lint":"eslint ./src","test":"npm run lint"},"keywords":["buildprovider","compile","homebrew","brew","formula"],"main":"lib/provider.js","engines":{"atom":">=1.0.0 <2.0.0"},"activationHooks":["language-ruby:grammar-used"],"providedServices":{"builder":{"description":"Builds and audits Homebrew formulas","versions":{"2.0.0":"provideBuilder"}}},"package-deps":["build"],"dependencies":{"atom-package-deps":"^5.1.0"},"devDependencies":{"@babel/core":"^7.4.5","babel-eslint":"^10.0.2","babel-loader":"^8.0.6","eslint":"^6.0.0","eslint-config-atom-build":"^4.0.0","husky":"^2.4.1","webpack":"^4.35.0","webpack-cli":"^3.3.5"},"eslintConfig":{"parser":"babel-eslint","extends":"atom-build","rules":{"consistent-return":0,"no-console":0}},"husky":{"hooks":{"pre-commit":"npm run lint"}}};
...
var _assert = _interopRequireDefault(__webpack_require__(6));

var Helpers = _interopRequireWildcard(__webpack_require__(7));
...
var _sbFs = _interopRequireDefault(__webpack_require__(8));

var _path = _interopRequireDefault(__webpack_require__(13));

var _semver = _interopRequireDefault(__webpack_require__(14));

var _atom = __webpack_require__(15);
...
var _fs = _interopRequireDefault(__webpack_require__(9));

var _util = __webpack_require__(10);

var _stripBomBuf = _interopRequireDefault(__webpack_require__(11));
...
const isUtf8 = __webpack_require__(12);
